...
void IR_Send_Pulse(uint8_t Type, uint16_t Time)
{
  ...
  while (Time >= 100)         /* 100�s chunks */
  {
    _delay_us(100);
    Time -= 100;
  }

  while (Time >= 10)          /* 10�s chunks */
  {
    _delay_us(10);
    Time -= 10;
  }

  while (Time > 0)            /* 1�s chunks */
  {
    _delay_us(1);
    Time--;
  }
 ...
 *  - tP: time units of pulse/pause in �s
 */
 ...
 *  - Code: pointer to code data
 *  - Bits: number of bits in code data
 *  - tP: time units of pause in �s
 *  - t0: time units of pulse for 0 in �s
 *  - t1: time units of pulse for 1 in �s
 */
 ...
 *  - Code: pointer to code data
 *  - Bits: number of bits in code data
 *  - tP: time units of pulse in �s
 *  - t0: time units of pause for 0 in �s
 *  - t1: time units of pause for 1 in �s
 */
 ...
 *  - Code: pointer to code data
 *  - Bits: number of bits in code data
 *  - tP: time units of fixed pulse/pause in �s
 *  - t0: time units of pulse/pause for 0 in �s
 *  - t1: time units of pulse/pause for 1 in �s
 *
 *  returns:
 *  - time in ms
 */
